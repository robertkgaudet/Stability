...
/* this StoredProcedure chnage */
USE [DB_8013_development]
GO
/****** Object:  StoredProcedure [dbo].[GetPeopleList]    Script Date: 5/23/2025 9:03:10 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN      
    ...
    JOIN aspnet_Membership net ON p.UserId = net.UserId      
    JOIN aspnet_Users u ON p.UserId = u.UserId      
    WHERE uo.OrganizationId = @OrganizationId AND IsEnabled=1
