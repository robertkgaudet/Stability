...
public partial class V1_MasterPages_SurvivorSurvey : System.Web.UI.MasterPage
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		bodyTag = "<body class=\"sidebar-scroll fixed-navbar " + fixedFooter + " " + fixedFooter + " bodyBGColor\">";
