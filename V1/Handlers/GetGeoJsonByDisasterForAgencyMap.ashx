<%@ WebHandler Language="C#" Class="GetGeoJsonByDisasterForAgencyMap" %>
...
public class GetGeoJsonByDisasterForAgencyMap: IHttpHandler, IReadOnlySessionState
{
	public void ProcessRequest (HttpContext context)
	{
		...
		try
		{
			...
			var locationJson = dc.GetGeoJsonByDisasterForAgencyMap(new Guid(eventId));
