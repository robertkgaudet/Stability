        ...
        try
        {
            ...
            foreach (var post in posts)
            {
                ...
                results += "<div class='hpanel messageBody'><div class='panel-body'><div class='message'><div class='block-profile-image-div clearfix' style='line-height: 1.3;'>" +
                        ...
                        "<div class='row' style='margin: -5px 5px -18px 5px'><span>" + litReactionCount + "</span><span style='float: right'>100 comments</span></div><hr />" +
                        "<div class='row'><div class='col-xs-3 post-type-div thankButton text-muted' data-item-id='" + post.PostId + "'>" + litReactionTitle +
                        "</div><div class='col-xs-3 post-type-div' id='commentButton'><i class='fa fa-sticky-note m-r-sm nowrap'></i>Comment</div><div class='col-xs-3 post-type-div' id='helpButton'>" +
