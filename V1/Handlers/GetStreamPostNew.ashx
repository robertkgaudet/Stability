	...
	public void ProcessRequest(HttpContext context)
	{
		...
		try
		{
			...
			foreach (var post in posts)
			{
				...
				var imageTag = "/V1/Images/ProfilePhotos/profilepicture.png";
				...
				string htmlContent = "" + Environment.NewLine +
				"<div class=\"hpanel messageBody\">" + Environment.NewLine +
				"    <div class=\"panel-body\">" + Environment.NewLine +
				"        <div class=\"message\">" + Environment.NewLine +
				"            <div class=\"block-profile-image-div clearfix\" style=\"line-height: 1.3;\">" + Environment.NewLine +
				"                <a id=\"ContentPlaceHolder1_rptPosts_linkProfile_9\" style=\"float: left; margin-right: 10px;\">" + Environment.NewLine +
				"                    <img src=\"" + imageTag + "\" id=\"ContentPlaceHolder1_rptPosts_imgProfile_9\" class=\"img-rounded\" width=\"40\">" + Environment.NewLine +
				"                </a>" + Environment.NewLine +
				"                <a id=\"ContentPlaceHolder1_rptPosts_ucUserNameWithBadges_9_hypName_9\" class=\"StreamLink\" href=\"/V1/Member/Default.aspx?userId=" + post.UserId + "\"><span id=\"ContentPlaceHolder1_rptPosts_ucUserNameWithBadges_9_lblprofileusername_9\" class=\"user-name\">" + post.fullname + "</span></a>" + Environment.NewLine +
				//"                <a id=\"ContentPlaceHolder1_rptPosts_hypPortalLink_9\" class=\"StreamPortalLink\">" + hypPortalLink + "</a>"  + Environment.NewLine +
				"                <br>" + Environment.NewLine +
				"                <span id=\"ContentPlaceHolder1_rptPosts_lblMessageDate_9\" class=\"message-date\">" + CrowdRelief.Tools.GetElapsedTime(Convert.ToDateTime(post.CreatedOn)) + "</span>" + Environment.NewLine +
				"                <br>" + Environment.NewLine +
				"                <span id=\"ContentPlaceHolder1_rptPosts_hypPortalLink_9\" class=\"message-date\">" + hypPortalLink + "</span>" + Environment.NewLine +
				"            </div>" + Environment.NewLine +
				"            <span class=\"message-content\">" + Environment.NewLine +
				"                <p style=\"margin-top: 10px;\">" + Environment.NewLine +
				"                </p><div class=\"post\"><p>" + postHtml + "</p></div>" + Environment.NewLine +
				"                <p></p>" + Environment.NewLine +
				"            </span>" + Environment.NewLine +
				"        </div>" + Environment.NewLine +
				"    </div>" + Environment.NewLine +
				"    <div class=\"panel-footer\">" + Environment.NewLine +
				"        <div class=\"row\" style=\"margin: -5px 5px -18px 5px\">" + Environment.NewLine +
				"            <span data-item-rid=" + post.PostId + ">" + Environment.NewLine +
				"                <div>" + litReactionCount + "</div>" + Environment.NewLine +
				"            </span>" + Environment.NewLine +
				"            <span style=\"float: right; margin-top: -23px\">" + Environment.NewLine +
				"                <div class=\"post-type-div commentSection showCommentsCount\" data-item-id=" + post.PostId + ">" + Environment.NewLine +
				"                    " + postCount + " Comments" + Environment.NewLine +
				"                </div>" + Environment.NewLine +
				"            </span>" + Environment.NewLine +
				"        </div>" + Environment.NewLine +
				"        <hr>" + Environment.NewLine +
				"        <div class=\"row\" style=\"margin-top: -18px !important\">" + Environment.NewLine +
				"            <div class=\"col-xs-3 post-type-div thankButton text-muted\" data-item-cid=" + post.PostId + ">" + Environment.NewLine +
				"                " + litReactionTitle + "" + Environment.NewLine +
				"            </div>" + Environment.NewLine +
				"            <div class=\"col-xs-3 post-type-div commentSection\" data-item-id=" + post.PostId + "><i class=\"fa fa-sticky-note m-r-sm nowrap\"></i>Comment</div>" + Environment.NewLine +
				"        </div>" + Environment.NewLine;

				if (postComments.Count > 0)
				{
					htmlContent += "        <div id=\"ContentPlaceHolder1_rptPosts_commentSectionShow_9\" class=\"comment-section-show\">" + Environment.NewLine;
				}
				else
				{
					htmlContent += "        <div id=\"ContentPlaceHolder1_rptPosts_commentSectionShow_9\" class=\"comment-section-show\" style=\"display:none;\">" + Environment.NewLine;
				}
				htmlContent += "            <div class=\"comment-section-repeater-show\" data-item-id=" + post.PostId + "-showComments>" + Environment.NewLine;
				foreach (var item in postComments)
				{
					htmlContent += "                <ul class=\"comments\">" + Environment.NewLine +
					 "                    <li>" + Environment.NewLine +
					 "                        <div class=\"userImage\">" + Environment.NewLine +
					 "                            <a target=\"_blank\" href=" + item.ProfileUrl + ">" + Environment.NewLine +
					 "                                <img class=\"img-rounded\" src=" + item.ImgProfileUrl + "></a>" + Environment.NewLine +
					 "                        </div>" + Environment.NewLine +
					 "                        <div class=\"commentReact\">" + Environment.NewLine +
					 "                            <span style=\"font-weight: bold; width: 70%; height: 22px;\">" + Environment.NewLine +
					 "                                <a id=\"ContentPlaceHolder1_rptPosts_rptPostCommentsShow_9_ucTeamLogo_0_hypName_0\" class=\"StreamLink\" href=" + item.ProfileUrl + "><span id=\"ContentPlaceHolder1_rptPosts_rptPostCommentsShow_9_ucTeamLogo_0_lblprofileusername_0\" class=\"user-name\">" + item.author + "</span></a>" + Environment.NewLine +
					 "                            </span>" + Environment.NewLine +
					 "                            <span style=\"float: right; width: 12%; text-align: right; margin: 0px 5px 0px 0px;\">" + item.timeAgo + "</span>" + Environment.NewLine +
					 "                            <span>" + item.Comment1 + "</span>" + Environment.NewLine +
					 "                        </div>" + Environment.NewLine +
					 "                    </li>" + Environment.NewLine +
					 "                </ul>" + Environment.NewLine;
				}
				htmlContent += "            </div>" + Environment.NewLine +
				"        </div>" + Environment.NewLine +
				"    </div>" + Environment.NewLine +
				"</div>" + Environment.NewLine;
