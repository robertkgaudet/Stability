...
public partial class V1_Administration_Item_ItemPhotoCrop : BaseOrganizationWebForm
{
	protected string itemPhotoFolder = System.Configuration.ConfigurationManager.AppSettings["itemPhotoFolder"].ToString();
	protected void Page_Load(object sender, EventArgs e)
	{
		string imageNameResized =  Request.QueryString["imageNameResized"];
		imgProfilePhoto.ImageUrl = itemPhotoFolder + imageNameResized;
	}
	...
	protected void btnUpdate_Click(object sender, EventArgs e)
	{
		try
		{
			...
			string imageFileFolder			= Server.MapPath(itemPhotoFolder);
