<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="LocationList.aspx.cs" Inherits="V1_Administration_Location_LocationList" %>
					...
					<div class="hpanel">
						<div class="panel-body">
							...
							<h2 class="font-light m-b-xs">
								Locations
								<label Class="btn btn-primary btn-lg pull-right m-r-lg btnAddLocation">Add Location</label>
							</h2>
						</div>
					</div>
				</div>
					...
					<div class="hpanel">
						...
						<div class="panel-body">
							<div class="p-l-lg">
								...
								<asp:Repeater ID="rpLocations" runat="server" OnItemDataBound="dlLocationTable_ItemDataBound">
									<HeaderTemplate>
										<table id="locationTable" class="footable table table-bordered table-hover" data-page-size="50" data-filter="#filter">
											<thead>
												<tr>
													...
													<th data-toggle="true" data-hide="phone,tablet">POC Name</th>
													<th data-toggle="true" data-hide="phone,tablet">POC Phone</th>
													<th data-toggle="true" data-hide="phone,tablet">On Map/Is Active</th>
													<th data-toggle="true" data-hide="phone,tablet">Type</th>
												</tr>
											</thead>
											<tbody>
									</HeaderTemplate>
									<ItemTemplate>
											<tr>
												<td><asp:HyperLink ID="hypEdit" runat="server"></asp:HyperLink></td>
												<td>
												...
												<td><asp:Literal ID="litPointOfContact" runat="server"></asp:Literal></td>
												<td><asp:HyperLink ID="hypPhoneNumber" runat="server"></asp:HyperLink></td>
												<td><asp:Literal ID="litOnMapIsActive" runat="server"></asp:Literal></td>
