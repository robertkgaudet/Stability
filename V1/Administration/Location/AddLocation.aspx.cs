...
public partial class V1_Administration_Resources_AddLocation : BaseOrganizationWebForm
{
	...
	protected void btnSubmit_Click(object sender, EventArgs e)
	{
		...
		if (!String.IsNullOrEmpty(hidAddressData.Value))
		{
			...
			Response.Redirect("/V1/Administration/Location/EditLocation.aspx?addressId=" + addressArray[13]);
		}
		else
		{
			//Error sending data.
