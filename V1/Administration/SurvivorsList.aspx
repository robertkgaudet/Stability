<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="SurvivorsList.aspx.cs" Inherits="Administration_SurvivorList" %>
				...
				<div class="col-lg-12 container">
					<div class="hpanel">
						<div class="panel-heading">
							...
							Sort, page, search to find survivor.
						</div>
						<div class="panel-body">
							<input type="text" class="form-control input-sm m-b-md" id="filter" placeholder="Search in table">
							<table id="tblVictims" class="footable table table-stripped toggle-arrow-tiny" data-page-size="50" data-filter=#filter>
								<thead>
									<tr>
								...
								<tbody>
									<asp:Repeater ID="dlVictims" runat="server" OnItemDataBound="dlVictims_ItemDataBound">
										<ItemTemplate>
											<tr>
