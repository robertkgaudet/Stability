...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div class="row">
            ...
            <div class="col-xs-8 col-sm-6 col-lg-4" style="min-width:320px !important;max-width:320px !important;">
				...
				<p style="font-weight:bold">Get your UserName?</p>
				<div class="m-t justify-content-center" role="form">
					<div class="form-group">
						<asp:PasswordRecovery
								...
								BackColor="White"
								SubmitButtonText="Recover UserName"
								UserNameLabelText="Email: "
								OnSendingMail="UserNameRecovery2_SendingMail"
								SuccessText="A UserName has been emailed to you.">
