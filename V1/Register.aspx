							...
							<div class="panel-body">
								<div class="row">
									<div class="form-group col-lg-12 line-s" runat="server" id="divChooseNonprofit">
										...
										<br /><small>Leave empty to create your own.</small>
									...
									<div class="form-group col-lg-12">
										<asp:CheckBox ID="chkMessageOptIn" runat="server" Text="Receive SMS Messages For Volunteer Opportunities and Deployments" />
									</div>
								</div>
