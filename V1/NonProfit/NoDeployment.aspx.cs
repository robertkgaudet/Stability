...
public partial class V1_NonProfit_NonProfitCampaign : BaseOrganizationWebForm
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ucPostionNavigation1.URLFriendlyName = organizationEvent.oe.URLFriendlyCampaignName;
        ...
        ucPostionNavigation1.CampaignName = organizationEvent.oe.CampaignName;
        ucPostionNavigation1.OrganizationName = organizationEvent.o.Name;
        ucPostionNavigation1.PortalName = organizationEvent.ev.Name;
        ucPostionNavigation1.PortalId = organizationEvent.ev.EventId.ToString();
        ucPostionNavigation1.OrganizationId = organizationEvent.o.OrganizationId.ToString();
        ucPostionNavigation1.Description = organizationEvent.oe.MissionPurpose;
