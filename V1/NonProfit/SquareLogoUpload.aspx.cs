...
public partial class V1_NonProfit_SquareLogoUpload : BaseOrganizationWebForm
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
		...
		int logoImageWidth = 300;  //Int32.Parse(System.Configuration.ConfigurationManager.AppSettings["squareLogoWidth"].ToString());
        int logoImageHeight = 300; //Int32.Parse(System.Configuration.ConfigurationManager.AppSettings["squareImageHeight"].ToString());
                ...
                try
                {
                    if (profilePhotoUpload.PostedFile.ContentType == "image/jpeg" || profilePhotoUpload.PostedFile.ContentType == "image/png")
                    {
                        if (profilePhotoUpload.PostedFile.ContentLength < 5242880)
                        {
                            ...
                            //Insert the image.
                            organization.LogoSquare = imageNameOriginal;
                            dc.SubmitChanges();
