...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="panel-body">
        <h2 class="font-light m-b-xs">Edit Donation Settings</h2>
        <!-- Save Button -->
                ...
                <asp:GridView ID="gvDonationCampaigns" runat="server" AutoGenerateColumns="False" DataKeyNames="DonationCampaignId" OnRowCommand="gvCampaigns_RowCommand" OnRowDataBound="gvDonationCampaigns_RowDataBound" CssClass="table table-bordered">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Preview">
                            <ItemTemplate>
                                <a href='<%# "DonationDetails.aspx?organizationId=" + Request.QueryString["organizationId"] + "&donationCampaignId=" + Eval("DonationCampaignId") %>'
                                    target="_blank">Campaign Preview
                                </a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <div class="modal-dialog modal-lg modal-fullscreen" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="<%= chkIsDefault.UniqueID %>">Is Default</label>
                                    <div class="col-sm-10">
                                        <div class="checkbox-hide">
                                            <asp:CheckBox ID="chkIsDefault" runat="server" CssClass="chkIsDefault" />
                                        </div>
                                    </div>
                                </div>
