...
public partial class V1_NonProfitAdministration_Reports : BaseWebForm
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		Master.PageTitle = organization.Name + " Team Reports on Stability";
		...
		Master.FbSite_name = organization.Name + " Team Reports on Stability";
		Master.FbURL = Request.Url.AbsoluteUri;

		ucTeamNavigation.PageName = "reportPage";
