<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/1-Column-Child.master"
    ValidateRequest="false" AutoEventWireup="true" CodeFile="PositionsNeeded1.aspx.cs"
    Inherits="V1_NonProfitAdministration_PositionsNeeded" %>

<%@ Register Src="~/V1/UserControls/PositionNavigation1.ascx" TagPrefix="uc1" TagName="PostionNavigation1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <uc1:PostionNavigation1 runat="server" ID="ucPostionNavigation1" />
    <div class="child-master-container">
        <div class="row">
            <div class="col-xs-12">
                <h3>
                    <asp:Literal ID="litEventName" runat="server"></asp:Literal></h3>
                <asp:HyperLink ID="btnPreviewPositions" Target="_blank" runat="server" Text="Preview Positions"
                    CssClass="btn btn-primary2 pull-right previewPositions"></asp:HyperLink>
                <h4>Add Postions</h4>
                Build your deployment team. Enter the positions you think you will need to help
                you operate a successful deployment. Once your positions are created, your team
                will be able to easily claim an open position.
				<br />
                <br />
                To start, enter a position name like "Deployment Team Lead" or "Cook". Click 'Preview
                Positions' at any time to view your team, this will open a new window so it will
                not interrupt what you are building on this page.
				<hr />
            </div>
        </div>
        ...
        <div class="hpanel position-information positionPanel">
            ...
            <div class="panel-body">
                <span class="text-muted">Add position, number of persons and arrival times. Select <span
                    class="font-bold">' + Add Another'</span> to add more positions. New positions will
                    be added to the database.</span>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-1" style="min-width: 300px !important;">
                            <div class="input-group m-b" id="container">
                                ...
                                <div class="autocomplete-wrapper">
                                    <input type="text" name="position[]" required class="form-control input-position-name autocomplete-input"
                                        style="width: 225px !important;" placeholder="EX:Cook, Deliver Supplies, Chainsaw">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-1">
                            <div class="input-group m-b">
                                ...
                                <input type="text" name="positionCount[]" required maxlength="2" class="form-control input-positions-needed"
                                    value="1" style="width: 60px !important;">
                            </div>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="row" style="margin-bottom: 40px;">
            <div class="col-xs-12">
                <button type="button" class="btn btn-primary pull-right" id="duplicateButton">
                    + Add
                    Another Position Form</button>
            </div>
        </div>
        ...
        <div class="hpanel position-calendar positionPanel">
            <div class="panel-heading">
                ...
                <div class="text-muted" style="font-size: 14px; font-weight: normal;">
                    If you're unsure,
                    dates can be selected later.
                </div>
            </div>
        ...
        <div class="hpanel position-message positionPanel">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <div class="col-sm-12">
                        <span class="text-muted">Enter extra details such as job descriptions, instructions,
                            links to maps or videos.
							<br />
                            Details here will be automatically included in confirmation and reminder messages.</span>
                        <asp:TextBox ID="txtMessage" CssClass="form-control" runat="server" TextMode="MultiLine"
...
<div class="hpanel position-message positionPanel">
    <div class="panel-heading">
        <span class="circle">4</span> Add the Address
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" runat="server" id="txtAddress" class="form-control i-check"
                               placeholder="Address" onblur="CheckAddressValues('address', this)" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 control-label">City</label>
                    <div class="col-sm-10">
                        <input type="text" runat="server" id="txtCity" class="form-control"
                               placeholder="City" onblur="CheckAddressValues('city', this)" />
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <asp:DropDownList ID="ddlState" runat="server" DataTextField="Text" DataValueField="Value"
                            CssClass="form-control" onchange="CheckAddressValues('state', this)">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" runat="server" id="txtZipCode" class="form-control"
                               placeholder="Zip Code" onblur="CheckAddressValues('zip', this)" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-2" style="padding: 10px;">
                <div class="pull-left">
                    <asp:LinkButton ID="btnCancel" CausesValidation="false" runat="server" OnClick="btnSubmit_Cancel"
                        CssClass="btn btn-default m-r-sm" Text="Cancel" />
                </div>
            </div>
