<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="CoverImage1600x600.aspx.cs" Inherits="V1_NonProfitAdministration_CoverImage1600x600" %>
					...
					<div class="form-horizontal">
						...
						<div class="col-sm-12">
							...
							<div class="m-t-lg">
								...
								<div class="m-b-md">
									<asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn btn-success pull-left" Text="Upload Cover Image" CausesValidation="false" OnClick="btnUpdate_Click" />
								</div>
							</div>
						</div>
					</div>
