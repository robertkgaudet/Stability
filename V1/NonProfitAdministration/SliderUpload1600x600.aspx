<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="SliderUpload1600x600.aspx.cs" Inherits="V1_NonProfitAdministration_SliderUpload1600x600" %>
			...
			<div class="row">
				<div class="col-sm-12 well">
					<div class="form-horizontal">
						<h1>Upload Cause Image</h1>
						<div class="col-sm-12">
							<label class="col-md-3">(Image must be 1600 x 600.)</label>
							<div class="m-t-lg">
								...
								<div class="m-b-md">
									<asp:LinkButton ID="btnUpdate" runat="server" CssClass="btn btn-success pull-left" Text="Upload Cause Photo" CausesValidation="false" OnClick="btnUpdate_Click" />
								</div>
							</div>
						</div>
					</div>
