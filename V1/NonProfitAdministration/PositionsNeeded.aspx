	...
	<script>
		$(document).ready(function () {
			...
			$('#duplicateButton').on('click', function () {
				...
				//clonedDiv.find('input[type="text"]:not(.clockpicker)').val('');
	...
	<div class="child-master-container">
		...
		<div class="hpanel position-information positionPanel">
			...
			<div class="panel-body">
				<span class="text-muted">Add position, number of persons and arrival times. Select + Add Another to add more positions.</span>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-1" style="min-width:300px !important;">
							<div class="input-group m-b">
								...
								<input type="text" name="position[]" required class="form-control input-position-name" style="width:225px !important;" placeholder="EX:Cook, Deliver Supplies, Chainsaw">
							</div>
						</div>
						<div class="col-xs-12 col-sm-1">
							<div class="input-group m-b">
								<span class="input-group-addon"># Needed:</span>
								<input type="text" name="positionCount[]" required maxlength="2" class="form-control input-positions-needed" style="width:60px !important;">
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-xs-12">
							<div class="form-group">
								<div class="checkbox checkbox-info" style="margin-top:0px !important; margin-left:20px !important;">
									<input id="checkbox4" type="checkbox" style="width:20px !important;">
		...
		<div class="row" style="margin-bottom:40px;">
			<div class="col-xs-12">
				<button type="button" class="btn btn-primary pull-left" id="duplicateButton"> + Add Another</button>
			</div>
		</div>
		...
		<div class="hpanel position-calendar positionPanel">
			<div class="panel-heading">
				<span class="circle">2</span> What days do you need positions filled?
			</div>
			<div class="panel-body">
