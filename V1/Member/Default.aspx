			...
			<div class="col-sm-8 col-lg-9">
				...
				<div class="hpanel">
					<div class="alert <%=availabilityStyle%> member-panel-body">
						<button Class="btn btn-success pull-right" onclick="updateCalendar(); return false;" runat="server" id="btnUpdateCalendar" ClientIDMode="static" Visible="false"><i class='fa fa-calendar'></i> <b>Update My Calendar</b></br>Add dates you want to volunteer to your calendar.</button>
						<h4>Availability</h4>
				...
				<div class="hpanel">
					<div class="panel-body member-panel-body">
						<h4>Skills & Available Resources</h4>
						<p style="font-size:16px;">
							<asp:Literal ID="litSkills" runat="server"></asp:Literal><br />
