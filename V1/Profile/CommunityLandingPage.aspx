<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/1-Column-Child.master"
    Async="true" AutoEventWireup="true" CodeFile="CommunityLandingPage.aspx.cs" Inherits="V1_Profile_CommunityLandingPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style type="text/css">
        .panel-body.member-panel-body {
            ...
            color: #4a4a4a;
            !important /* Ensures font color overrides default ASP.NET theme */
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="civic-feed-wrapper">
        ...
        <div class="card weather-card">
            ...
            <div class="alert alert-success" style="margin: 30px -22px 20px -22px;">
                ...
                <small>
                    <i>
                        <asp:Literal ID="litTotalCitizens" runat="server"></asp:Literal></i>
                    <br />
        ...
        <div class="card">
            <asp:Repeater ID="rptDisasterCards" runat="server">
                <ItemTemplate>
                    <div class='panel <%# GetCardCssClass(Eval("Severity").ToString(), Eval("Urgency").ToString()) %>'
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                <a href='javascript:void(0)' onclick='toggleDetails(this)' style='text-decoration: underline;'>
                                    Show More</a>
                            </p>
                            <div class='alert-details' style='display: none;'>
                                <p><b>Sender:</b> <%# Eval("SenderName") %></p>
                                <p><b>Status:</b> <%# Eval("Status") %> | <b>Type:</b> <%# Eval("MessageType") %>
                                </p>
                                <p><b>Certainty:</b> <%# Eval("Certainty") %> | <b>Urgency:</b> <%# Eval("Urgency") %>
                                    | <b>Category:</b> <%# Eval("Category") %></p>
                                <p>
                                    <b>Issued:</b> <%# ((DateTime)Eval("Sent")).ToString("MMM dd, h:mm tt") %><br />
                                    <b>Effective:</b> <%# ((DateTime)Eval("Sent")).ToString("MMM dd, h:mm tt") %><br />
                                    <b>Expires:</b> <%# ((DateTime)Eval("Expires")).ToString("MMM dd, h:mm tt") %><br />
                                    <b>Ends:</b> <%# ((DateTime)Eval("Ends")).ToString("MMM dd, h:mm tt") %>
                                </p>
                            </div>
                            <a href='<%# Eval("Url") %>' target='_blank' class='btn btn-xs btn-warning'>View NWS
                                Official Alert</a>
                        </div>
                    </div>
                </ItemTemplate>
        ...
        <div class="card">
            <h5>
                <asp:Literal ID="litWeatherAdvisoryLocation" runat="server"></asp:Literal>
            </h5>
            <!-- List container -->
            <div class="list-group weather-advisory-list">
                <asp:Repeater ID="rptDisasterEvents" runat="server">
                    <ItemTemplate>
                        ...
                        <!-- Modal per item -->
                        <div class="modal fade" id='<%# "modal_" + Eval("Title").ToString().GetHashCode() %>'
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p><%# Eval("Summary") %></p>
                                        <p>
                                            <b>Source:</b> <%# Eval("Source") %><br />
                                            <b>Affected Area:</b> <%# Eval("Location") %><br />
                                            <b>Date:</b> <%# Eval("Date", "{0:MMM dd, yyyy}") %>
                                        </p>
                                    </div>
    ...
    <div class="modal fade" id="waiverModal" tabindex="-1" role="dialog" aria-labelledby="waiverModalLabel" data-backdrop="static" data-keyboard="false">
