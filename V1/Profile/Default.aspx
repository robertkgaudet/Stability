<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="V1_Profile_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
	
	<script src="/V1/Homer/vendor/fooTable/dist/footable.all.min.js"></script>
	<link rel="stylesheet" href="/V1/Homer/vendor/fooTable/css/footable.core.min.css" />
	<script>
				...
				<div class="panel-body">
					...
					<asp:Repeater ID="dlRebuildTable" runat="server" OnItemDataBound="dlRebuildTable_ItemDataBound">
						...
						<ItemTemplate>
								<tr>
									<td>
										<a href='Rebuild.aspx?rebuildId=<%# DataBinder.Eval(Container.DataItem, "RebuildId") %>' class="EventLink"><%# DataBinder.Eval(Container.DataItem, "Firstname") %> <%# DataBinder.Eval(Container.DataItem, "Lastname") %></a>
									</td>
