<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="Username.aspx.cs" Inherits="V1_Profile_Username" %>
				...
				<div class="col-lg-6 container">
					...
					<div class="hpanel form-horizontal">
						...
						<div class="panel-body">
							...
							NOTE: This process will sign you out. After completing, you will have to sign back in with your new username.
							...
							<div class="form-group m-t-lg">
								...
								<div class="col-sm-9"><input runat="server" id="txtUsername" class="form-control" placeholder="Username"></div>
							</div>
