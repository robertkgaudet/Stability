        ...
        <div class="hpanel">
            <div class="panel-body">
				...
				<div id="hbreadcrumb" class="pull-right">
					...
					<asp:HyperLink runat="server" ID="hypWebsite" CssClass="btn btn-primary2 pull-right" Target="_blank"><i class="fa fa-globe text-website"></i> Open Team Website</asp:HyperLink>
