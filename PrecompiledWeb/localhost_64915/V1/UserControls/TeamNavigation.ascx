<%@ control language="C#" autoeventwireup="true" inherits="V1_UserControls_TeamNavigation, App_Web_qaqxyxhv" %>
                ...
                <div class="hpanel">
                    <div class="panel-body">
						<asp:HyperLink runat="server" ID="hypWebsite" CssClass="btn btn-primary2 btn-block" Target="_blank"><i class="fa fa-globe text-website"></i> Open Team Website</asp:HyperLink>
