<%@ page title="" language="C#" masterpagefile="~/V1/MasterPages/Homer.master" autoeventwireup="true" inherits="V1_Profile_Resources, App_Web_oetfxeqz" %>
					...
					<div class="hpanel form-horizontal">
						...
						<div class="panel-body p-lg">
							...
							<div class="form-group m-t-lg">
								<asp:CheckBoxList ID="chkBoxListResources" runat="server" DataTextField="Name" DataValueField="ResourceId" RepeatDirection="Vertical"></asp:CheckBoxList>
							</div>
