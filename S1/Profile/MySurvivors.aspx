<%@ Page Title="" Language="C#" MasterPageFile="~/S1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="MySurvivors.aspx.cs" Inherits="S1_Profile_MySurvivors" %>
					...
					<asp:Repeater ID="rpSurvivorListTable" runat="server" OnItemDataBound="rpSurvivorListTable_ItemDataBound">
							...
							<table id="survivorTable" class="footable table table-bordered table-hover" data-page-size="20" data-filter="#filter">
								<thead>
									<tr>
										...
										<th data-toggle="true" data-hide="phone,tablet">Modify</th>
									</tr>
								</thead>
								<tbody>
						</HeaderTemplate>
						<ItemTemplate>
									<tr>
										...
										<td><asp:HyperLink ID="hypWishList" runat="server"></asp:HyperLink></td>
										...
										<td><asp:Literal ID="litDisaster" runat="server"></asp:Literal></td>
