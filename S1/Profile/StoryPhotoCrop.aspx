<%@ Page Title="" Language="C#" MasterPageFile="~/V1/MasterPages/Homer.master" AutoEventWireup="true" CodeFile="StoryPhotoCrop.aspx.cs" Inherits="S1_Profile_StoryPhotoCrop" %>
				...
				<div class="col-sm-12 well">
					<div class="form-horizontal">
						...
						<div class="col-sm-12">
							...
							<asp:Button ID="btnUpdate" runat="server" CssClass="btn btn-success" Text="Crop Story  Photo" CausesValidation="false" OnClick="btnUpdate_Click" />
