<%@ Page Title="" Language="C#" MasterPageFile="~/CaseManagement/MasterPages/CaseManagement.master" AutoEventWireup="true" CodeFile="AddCase.aspx.cs" Inherits="CaseManagement_AddCase" %>
		...
		<div class="panel-body">
			...
			<div class="form-group"><label class="col-sm-2 control-label">Stability Recovery Stage</label>
				<div class="col-sm-10">
					...
					<a href="Stages.aspx" target="_blank" class="small">Click to View Stage Descriptions</a> (Opens new Window)
			...
			<div class="form-group"><label class="col-sm-2 control-label">Vulnerabilities</label>
				<div class="col-sm-10">
					Choose Vulnerabilities (All that apply)
			...
			<div class="form-group"><label class="col-sm-2 control-label">Basic Needs</label>
				<div class="col-sm-10">
					Choose Basic Needs (All that apply)
					<div class="dropdown m-t-sm m-b-md">
						<asp:ListBox ID="ddlBasicNeeds" SelectionMode="Multiple" DataValueField="RebuildStatusId" DataTextField="Status" runat="server" CssClass="js-source-states-1"></asp:ListBox>
					</div>
					<div class="hr-line-dashed color-line"></div>
				</div>
			</div>
